...
public class LoginFrame extends JFrame {
    ...
    private JPanel createBrandPanel() {
        ...
        //     e.printStackTrace();
        // }
        brandPanel.add(UIFactory.createImageLabel("src/com/mrt/img/logo_train.png", new Dimension(120, 120)));
    ...
    private JPanel createLoginForm() {
        ...
        JButton forgotBtn = UIFactory.createButton("[Forgot password?]");
