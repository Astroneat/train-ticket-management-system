package com.mrt.user.schedules.search;
...
public class ScheduleSearchPanel extends JPanel {
    ...
    private JPanel createTopPanel() {
        ...
        upcomingPanel.add(UIFactory.createBoldLabel("Upcoming Schedules", 24));
    ...
    private JPanel createSearchPanel() {
        ...
        buyBtn.addActionListener(e -> {
            ...
            if(row != -1) {
                ...
                parentPanel.showStep(BookingStep.SEATS);
            }
        });
