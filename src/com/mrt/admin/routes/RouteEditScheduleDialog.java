...
public class RouteEditScheduleDialog extends JDialog {
    ...
    public RouteEditScheduleDialog(JDialog parent, Schedule schedule) {
    ...
    private JPanel createButtonsPanel() {
        ...
        saveBtn.addActionListener(e -> {
            ...
            int state = ScheduleService.updateSchedule(schedule.getScheduleId(), train.getTrainId(), departure, arrival);
